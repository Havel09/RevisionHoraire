...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    createCreneaux($_POST['classe_id'], $_POST['cours_id'], $_POST['jour'], $_POST['heure_debut'], $_POST['heure_fin'], $_POST['salle']);
}
...
foreach ($classes as $classe) {
    $classesParId[$classe['id']] = $classe['nom'];
}

$coursParId = [];
foreach ($cours as $c) {
    $coursParId[$c['id']] = $c['nom'];
}
?>
...
<main class="container my-4">
    <nav>
        <ul class="nav nav-pills justify-content-center my-4">
            ...
            <li class="nav-item"><a class="nav-link active" href="horaire.php">Horaire</a></li>
        </ul>
    </nav>
